...
const h1_presale_mint = "GORILLABYTE Pre-Sale Minting Open!!";
const h1_public_mint = "GORILLABYTE Public Minting Open!!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "We are working hard to launch the GORILLABYES. Stay tuned for updates!";
...
const button_presale_coming_soon = "Get on the Whitelist All Gorillabit holders are on the whitelist!";
const button_presale_mint_whitelisted = "Mint Your GORILLABYTE";
const button_presale_mint_not_whitelisted = "Get on the Whitelist by owning a gorillabit or participating in our WL giveaways";
const button_presale_already_minted = "Already minted enjoy your GORILLABYTE";
const button_public_mint = "Mint Your GORILLABYTE";
